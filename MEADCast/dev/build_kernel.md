...
## Apply patch
Apply the MEADcast patch file from my GitHub repo to the kernel source by
moving into the corresponding directory and running:
```sh
...
To install the Kernel in the VM run:
```sh
